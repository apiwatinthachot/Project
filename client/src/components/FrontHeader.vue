        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active" role="presentation">
              <span  type="button" class="font1" style="color: #000000" v-on:click="navigateTo('/front')"><i class="fas fa-home"></i> หน้าหลัก</span>
            </li>
            <li class="nav-item" v-if="!isUserLoggedIn" role="presentation">
              <span  type="button" v-on:click.prevent="showLogin = true">&nbsp;&nbsp;&nbsp;<span  class="font1" style="color: #000000">เข้าสู่ระบบ</span></span>
            </li>

            <li class="nav-item" v-if="!isUserLoggedIn" role="presentation">
              <span  type="button" v-on:click.prevent="showRegister = true">&nbsp;&nbsp;&nbsp;<span  class="font1" style="color: #000000">สมัครสมาชิก</span></span>
            </li>
            <transition name="fade">
              <li v-if="isUserLoggedIn" role="presentation">
                <router-link v-bind:to="{ name: 'login' }">{{ user.name }}
               </router-link>
              </li>
            </transition>
            <li class="nav-item" v-if="isUserLoggedIn" role="presentation">
              <span  type="button" v-on:click.prevent="logout">&nbsp;&nbsp;&nbsp;<span  class="font1" style="color: #000000">ออกจากระบบ</span></span>
            </li>
          </ul>
